...
// Martin 01/06/2026: rutas para ver el carrito y procesar el pago -checkout-
Route::get('/carrito', [CarritoController::class, 'mostrar'])->name('carrito.mostrar');
Route::post('/checkout', [PedidosController::class, 'confirmarPedido'])->name('pedido.confirmar');